...
ActiveRecord::Schema.define(:version => 20171018071713) do
  ...
  add_index "guw_guw_unit_of_works", ["guw_model_id", "guw_type_id", "module_project_id", "pbs_project_element_id", "guw_unit_of_work_group_id"], :name => "module_project_guw_unit_of_works"
  ...
  create_table "users", :force => true do |t|
    ...
    t.text     "description"
    t.datetime "subscription_end_date",  :default => '2017-02-08 11:25:43'
  end
