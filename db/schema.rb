...
ActiveRecord::Schema.define(version: 20201208100559) do
  ...
  add_index "guw_guw_attribute_types", ["organization_id", "guw_model_id", "guw_attribute_id", "guw_type_id"], name: "by_organization_guw_model_attribute_type_2", using: :btree
  ...
  add_index "guw_guw_attributes", ["organization_id", "guw_model_id", "name"], name: "by_organization_guw_model_name_7", using: :btree
  ...
  add_index "guw_guw_coefficients", ["organization_id", "guw_model_id", "name"], name: "by_organization_guw_model_name_2", using: :btree
  ...
  add_index "guw_guw_complexities", ["organization_id", "guw_model_id", "guw_type_id", "name"], name: "by_organization_guw_model_type_name_2", using: :btree
  ...
  add_index "guw_guw_complexity_work_units", ["organization_id", "guw_model_id", "guw_work_unit_id", "guw_complexity_id"], name: "by_organization_guw_model_name_3", using: :btree
  ...
  add_index "guw_guw_output_complexity_initializations", ["organization_id", "guw_model_id", "guw_output_id", "guw_complexity_id"], name: "by_organization_guw_model_output_cplx_2", using: :btree
  ...
  add_index "guw_guw_outputs", ["organization_id", "guw_model_id", "name"], name: "by_organization_guw_model_name_4", using: :btree
  ...
  add_index "guw_guw_types", ["organization_id", "guw_model_id", "name"], name: "by_organization_guw_model_name_5", using: :btree
  ...
  add_index "guw_guw_work_units", ["organization_id", "guw_model_id", "name"], name: "by_organization_guw_model_name_6", using: :btree
  ...
  create_table "versions", force: :cascade do |t|
    ...
    t.text     "object",                            limit: 65535 #4294967295
    t.datetime "created_at"
