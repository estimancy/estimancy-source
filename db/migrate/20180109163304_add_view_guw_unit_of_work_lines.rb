class AddViewGuwUnitOfWorkLines < ActiveRecord::Migration
  def up
    ...
    SELECT o.id AS uow_organization_id, o.name AS organization_name,
                  ...
                  ceuw.guw_coefficient_element_id, ceuw.guw_coefficient_id, ceuw.percent, ceuw.comments
    ...
    # NEW
    INNER JOIN guw_guw_coefficient_element_unit_of_works ceuw ON ceuw.guw_unit_of_work_id = guw_uow.id
                                                            AND ceuw.module_project_id = mp.id
