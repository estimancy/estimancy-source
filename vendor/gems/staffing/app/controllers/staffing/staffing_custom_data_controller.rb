...
class Staffing::StaffingCustomDataController < ApplicationController
  ...
  def save_data
    ...
    @md_duration = @staffing_model.mc_donell_coef * (effort.to_f * @staffing_model.standard_unit_coefficient.to_f / effort_week_unit.to_f) ** @staffing_model.puissance_n.to_f
    ...
    for t in 0..@md_duration
      ...
      t_staffing = (effort.to_f * @staffing_model.standard_unit_coefficient.to_f / @staffing_model.effort_week_unit.to_f) * form_coef * t * Math.exp(-form_coef*t*t)
