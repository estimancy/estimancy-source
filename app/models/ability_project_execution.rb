                    ...
                    #organization_estimation_statuses.each do |es|
                      prj_scrt_project_security_level_permissions.each do |permission|
                        if permission.alias == "manage" and permission.category == "Project"
                          can :manage, project, estimation_status_id: project.estimation_status_id
                        else
                          #@array_users << [permission.id, project.id, es.id]
                          @array_users << [permission.id, project.id, project.estimation_status_id]
                        end
                      end
                      #end
                  end
                        ...
                        #organization_estimation_statuses.each do |es|
                          prj_scrt_project_security_level_permissions.each do |permission|
                            if permission.alias == "manage" and permission.category == "Project"
                              ...
                              @array_owners << [permission.id, project.id, project.estimation_status_id]
                            end
                          end
                        #end
                      end
                        ...
                        prj_scrt_project_security_level_permissions.each do |permission|
                          if project.private == true && project.is_model != true
                            ...
                            if permission.alias == "manage" and permission.category == "Project"
                              ...
                              @array_groups << [permission.id, project.id, project.estimation_status_id]
                            end
                          end
                        end
                        #end
