class BudgetTypeStatusesController < ApplicationController
  def new
    ...
    set_breadcrumbs I18n.t(:budget_type_status) => organization_setting_path(@current_organization, anchor: "tabs-budget-type", partial_name: 'tabs_budgets_and_budget_types'), I18n.t('budget_type') => ""
  ...
  def create
    ...
    if @budget_type_status.save
      ...
      redirect_to redirect_apply(nil, new_organization_budget_type_status_path(@organization), organization_setting_path(@organization, :anchor => 'tabs-budget-type', partial_name: 'tabs_budgets_and_budget_types') )
    else
      render action: 'new'
    end
  end
  ...
  def update
    ...
    set_page_title I18n.t(:budget_type_status)
    set_breadcrumbs I18n.t(:budget_type_status) => organization_setting_path(@organization, anchor: "tabs-budget-type", partial_name: 'tabs_budgets_and_budget_types'), I18n.t(:edit_project_area) => ""
    ...
    if @budget_type_status.update_attributes(params[:budget_type_status])
      ...
      redirect_to redirect_apply(edit_organization_budget_type_status_path(@organization, @budget_type_status), nil, organization_setting_path(@organization, :anchor => 'tabs-budget-type', partial_name: 'tabs_budgets_and_budget_types') )
    else
      render action: 'edit'
    end
  end
