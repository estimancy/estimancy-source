class ModuleProjectRatioElementsController < ApplicationController
  ...
  def refresh_dashboard_module_project_ratio_elements
    ...
    if @wbs_activity_ratio
      ...
      @wbs_activity_input = WbsActivityInput.where(module_project_id: @module_project.id, wbs_activity_id: @module_project.wbs_activity_id, wbs_activity_ratio_id: @wbs_activity_ratio.id, pbs_project_element_id: @pbs_project_element.id).first
